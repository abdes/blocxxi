...
#
# To use in a specific CmakeLists.txt add the following (after adapting the
# parameters to the current module):
# ~~~
...
# ~~~
#
# Use 'cmake --preset=<preset_name> --build <build_directory> --target dox' to
# generate documentation. (not done by default)
...
if(NOT DNOVA_FOUND)
  ...
  function(
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/doxygen/Doxyfile.in")
      set(DOXY_OUTPUT_DIR "${DNOVA_BUILD_DIR}/${MODULE_NAME}")
  ...
  function(nova_with_doxygen)
    ...
    _add_dnova_target(${x_MODULE_NAME})
  endfunction()
  ...
  if(NOT TARGET dox)
    ...
    set(COLLECT_WARNINGS_SCRIPT "${DNOVA_BUILD_DIR}/collect_warnings.cmake")
    # cmake-format: off
    file(
      WRITE
    ...
    file(WRITE \"${DNOVA_BUILD_DIR}/${MODULE_NAME}/dnova_warnings.txt\" \"\")\n \
    ...
    foreach(MODULE \${DOX_MODULES})\n \
      ...
      file(APPEND \"${DNOVA_BUILD_DIR}/dnova_warnings.txt\" \"\${MODULE_WARNINGS}\")\n \
    endforeach(MODULE)\n \
    file(READ \"${DNOVA_BUILD_DIR}/dnova_warnings.txt\" ALL_WARNINGS)\n \
    string(COMPARE NOTEQUAL \"\${ALL_WARNINGS}\" \"\" DNOVA_HAD_WARNINGS)\n \
    if(DNOVA_HAD_WARNINGS)\n \
      # Print the warnings\n \
      message(\"\${ALL_WARNINGS}\")\n \
    endif(DNOVA_HAD_WARNINGS)\n"
    )
    # cmake-format: on
    ...
    add_custom_command(
      ...
      WORKING_DIRECTORY "${DNOVA_BUILD_DIR}"
