...
//  2018-06-08: Misc: Extracted imgui_impl_glfw.cpp/.h away from the old
...
void ImGui_ImplGlfw_MouseButtonCallback(GLFWwindow*, int button, int action,
                                        int /*mods*/) {
...
void ImGui_ImplGlfw_ScrollCallback(GLFWwindow*, double xoffset,
                                   double yoffset) {
...
void ImGui_ImplGlfw_KeyCallback(GLFWwindow*, int key, int, int action,
                                int mods) {
  ImGuiIO& io = ImGui::GetIO();
