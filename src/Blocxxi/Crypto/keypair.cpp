...
#endif
#include <cryptopp/eccrypto.h> // for cryptopp ECC encryption
#include <cryptopp/oids.h>     // for cryptopp ECC curve function
#include <cryptopp/osrng.h>    // for cryptopp random number generation
NOVA_DIAGNOSTIC_POP
